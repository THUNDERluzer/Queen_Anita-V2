...
module.exports = {
  ...
  REMOVE_BG_KEY: process.env.REMOVE_BG_KEY || "https://telegra.ph/file/0a42a3fc893e9918176d2.jpg",
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || "JnQGeUmmKtEuR1QkaZ0WT3BlbkFJcd4EKMo77glVBYhVCKLl",
  ...
  LANG: (process.env.THEME || "Hashan").toUpperCase(),
};
global.rank = "updated";
